...
If you disable background compaction then you can also increase the RAM per thread setting (`-m`) by 50% or so. This is because some of the provisioned memory is set aside for background compaction, and will not be used if they're disabled.
